...
Namespace ScoreKeeper.IntegrationTests.Features
    ...
    Partial Public Class StartGameFeature
        ...
        <NUnit.Framework.TestAttribute(),  _
         NUnit.Framework.DescriptionAttribute("Start a game with a valid point requirement and players")>  _
        Public Overridable Sub StartAGameWithAValidPointRequirementAndPlayers()
            Dim scenarioInfo As TechTalk.SpecFlow.ScenarioInfo = New TechTalk.SpecFlow.ScenarioInfo("Start a game with a valid point requirement and players", CType(Nothing,String()))
