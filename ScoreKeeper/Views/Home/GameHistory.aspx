<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(Of ScoreKeeper.GameHistoryViewModel)" %>
    ...
    <div data-role="content">
        <%  For Each game In Model.History %>
            <ul data-role="listview" data-inset="true">
                <li data-role="list-divider" <% If game.Status = ScoreKeeper.GameStatus.InProgress Then%>data-theme="e"<%Else %>data-theme="b"<%End If %>>
